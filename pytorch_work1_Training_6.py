...
import Networks.Seq_Ch_Ker_networks.Net_2_Seq_1_Ch_32_Ker_3 as network
...
for epoch in range(epochs):
    ...
    for idx, input_data in enumerate(norm_train_data):
        ...
        # calculate loss
        model_output = model_output[:, num_skin_points]
        norm_train_gt_data = norm_train_gt_data[:, num_skin_points]
