...
def get_model(input_tensor, is_training, bn_decay=None):
    ...
    out2_1 = tf_util.conv2d(net_1, second_CNN_channels[0], [2, 2],
                            padding='SAME', stride=[1, 1],
                            bn=True, is_training=is_training, weight_decay=weight_decay,
    ...
    out3_1 = tf_util.conv2d(net_2, third_CNN_channels[0], [2, 2],
                            padding='SAME', stride=[1, 1],
                            bn=True, is_training=is_training, weight_decay=weight_decay,
    ...
    out4_1 = tf_util.conv2d(net_3, fourth_CNN_channels[0], [2, 2],
                            padding='SAME', stride=[1, 1],
                            bn=True, is_training=is_training, weight_decay=weight_decay,
